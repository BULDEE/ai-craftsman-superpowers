...
metadata:
  hermes:
    tags: [craftsmanship, test]
    category: devops
    requires_toolsets: [terminal]
---

<!-- Generated by scripts/export-hermes-skills.sh from skills/test/SKILL.md. Edit the source, then re-run the export. -->
...
# the craftsman-test skill - Pragmatic Testing
...
- `references/testing-strategy.md` - pyramid vs trophy, FIRST, test doubles, maintainable E2E
- `references/tdd.md` - red-green-refactor, the three green strategies, AAA, test naming
- `references/legacy-characterization-testing.md` - golden master for untested legacy code
