...
[![Skills](https://img.shields.io/badge/Skills-22-orange)](COMMANDS-QUICK-REF.md)
...
- **Semantic Level 1.5**: LSP-backed validation between the regex gate and static analysis, wired through Anthropic's official per-language LSP plugins you opt into - the plugin orchestrates your stack's tooling, never substitutes for it.
