...
One-line cheat sheet for every `/craftsman:*` command. See [README.md](README.md#commands) for details, or [`/examples`](examples/) for full usage walkthroughs.
...
| `/craftsman:debug` | Systematic debugging using the ReAct pattern |
...
| `/craftsman:scaffold pack` | Create a new community pack |
...
| `/craftsman:agent-design` | Design AI agents using the 3P pattern (Perceive/Plan/Perform) |

## Utilities

| Command | What it does |
|---------|---------------|
| `/craftsman:metrics` | Quality metrics dashboard (violations, trends, sessions) |
...
| Command | What it does |
|---------|---------------|
| `/craftsman:ci` | Export quality gates to CI/CD (GitHub, GitLab, Bitbucket, Jenkins) |
