...
metadata:
  hermes:
    tags: [craftsmanship, spec]
    category: devops
    requires_toolsets: [terminal]
---

<!-- Generated by scripts/export-hermes-skills.sh from skills/spec/SKILL.md. Edit the source, then re-run the export. -->
...
# the craftsman-spec skill - Specification-First Development
