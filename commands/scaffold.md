---
name: scaffold
description: Analyze existing code and generate a context agent. Usage /craft scaffold <path>
---

# /craft scaffold - Intelligent Agent Generation
...
> Auto-generated by /craft scaffold
> Source: {path}
> Generated: {date}
...
```
/craft scaffold <path> --dry-run    # Preview without creating file
/craft scaffold <path> --force      # Overwrite existing agent
/craft scaffold <path> --output=X   # Custom output path
```
